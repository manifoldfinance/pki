...
At CommodityStream Inc, security is a priority. But regardless of
...
6.  The project team requests a CVE number from security at
    manifoldfinance.com by logging a request at: https://github.com/manifoldfinance/defi-threat
...
9.  The project team agrees to the fix, the announcement and the release
    schedule with the reporter. The level of detail to
...
13. The project team announces the vulnerability. The vulnerability
    ...
    3.  github.com/manifoldfinance/defi-threat
